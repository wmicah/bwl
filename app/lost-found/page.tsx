    ...
    <main className="min-h-screen bg-soft-white">
      ...
      <SectionContainer className="bg-soft-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 px-4 md:px-0">
          <ScrollReveal direction="down" delay={0} distance={50}>
            <h2 className="font-heading text-2xl md:text-3xl lg:text-4xl bg-gradient-to-r from-royal-blue to-teal bg-clip-text text-transparent mb-4 md:mb-6 text-center">
              How We Can Help
            </h2>
          </ScrollReveal>
          <ScrollReveal direction="fade" delay={150} distance={20}>
            <p className="text-base md:text-lg text-slate-gray leading-relaxed mb-6 md:mb-8 text-center max-w-2xl mx-auto px-4 md:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-8">
            <ScrollReveal direction="left" delay={200} distance={80}>
              <div className="bg-white rounded-lg p-5 md:p-6 border border-slate-200 shadow-sm">
                <div className="flex items-start space-x-3 md:space-x-4">
                  <div className="h-10 w-10 md:h-12 md:w-12 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Search className="h-5 w-5 md:h-6 md:w-6 text-teal" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <h3 className="font-heading font-semibold text-lg md:text-xl text-royal-blue mb-2">
                      Regular Collection
                    </h3>
                    <p className="text-sm md:text-base text-slate-gray">
            ...
            <ScrollReveal direction="right" delay={300} distance={80}>
              <div className="bg-white rounded-lg p-5 md:p-6 border border-slate-200 shadow-sm">
                <div className="flex items-start space-x-3 md:space-x-4">
                  <div className="h-10 w-10 md:h-12 md:w-12 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Clock className="h-5 w-5 md:h-6 md:w-6 text-teal" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <h3 className="font-heading font-semibold text-lg md:text-xl text-royal-blue mb-2">
                      Safe Storage
      ...
      <SectionContainer className="bg-cloud-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 px-4 md:px-0">
          <ScrollReveal direction="down" delay={0} distance={50}>
            <h2 className="font-heading text-2xl md:text-3xl lg:text-4xl bg-gradient-to-r from-royal-blue to-teal bg-clip-text text-transparent mb-4 md:mb-6">
              Report a Lost Item
            </h2>
          </ScrollReveal>
          
          <div className="bg-white rounded-lg p-5 md:p-6 lg:p-8 border border-slate-200 shadow-sm mb-8">
            <ScrollReveal direction="fade" delay={150} distance={20}>
              <p className="text-base md:text-lg text-slate-gray leading-relaxed mb-6">
              ...
              <div className="bg-teal/5 rounded-lg p-4 md:p-6 border-l-4 border-teal mb-6">
                <h3 className="font-heading font-semibold text-lg md:text-xl text-royal-blue mb-4">
                  Please Include in Your Message:
                </h3>
                <ul className="space-y-3 text-sm md:text-base text-slate-gray">
              ...
              <div className="bg-gradient-to-br from-teal/5 to-royal-blue/5 rounded-lg p-4 md:p-6 border-2 border-teal/20">
                <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm md:text-base text-slate-gray mb-4">
                    ...
                    <a
                      ...
                      className="inline-flex items-center text-teal hover:text-royal-blue transition-colors text-base md:text-lg font-medium break-all"
                    >
                      {BRAND.email}
      ...
      <SectionContainer className="bg-soft-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 px-4 md:px-0">
          <ScrollReveal direction="down" delay={0} distance={50}>
            <div className="bg-white rounded-lg p-5 md:p-6 lg:p-8 border border-slate-200 shadow-sm">
              <p className="text-sm md:text-base text-slate-gray leading-relaxed">
      ...
      <SectionContainer className="bg-cloud-white relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10 px-4 md:px-0">
          <ScrollReveal direction="fade" delay={0} distance={20}>
            <p className="text-base md:text-lg text-slate-gray mb-6">
