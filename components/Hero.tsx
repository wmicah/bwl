...
import { MapPin, WashingMachine } from "lucide-react"
...
export function Hero() {
  return (
    <section
      className='relative w-full min-h-[500px] md:min-h-[600px] bg-gradient-to-b from-white to-[#EAF7FB] flow-wave'
          ...
          <div className='space-y-4 md:space-y-5'>
            ...
            >
              <p className='text-base md:text-lg text-charcoal leading-relaxed max-w-xl'>
                Huge high-capacity machines, ozone sanitation, and laundry done
                in about 45 minutes.
              </p>
            ...
            <div className='relative'>
              ...
              <div className='relative rounded-card overflow-hidden shadow-card-hover water-droplet card-flow'>
                <div className='aspect-[4/3] relative image-blend-overlay'>
                  <Image
                    src='/images/speedqueenstock.JPG'
